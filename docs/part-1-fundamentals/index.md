...
> This is where the real learning begins. No more "Hello, World!" -- now we build something useful.

---

## What You'll Learn

In this part, you'll learn the building blocks of Python through projects that matter to Filipino life:
...
1. **Story hook** -- A narrative rooted in Filipino life
2. **What you'll learn** -- Clear objectives
3. **Tutorial** -- Step-by-step code walkthroughs
4. **Boss Fight** -- A challenge that tests everything
5. **Side Quests** -- Optional extra practice
